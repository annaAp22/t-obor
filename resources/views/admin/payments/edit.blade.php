                        ...
                        <div class="col-sm-9">
                            <div class="tabbable">
                                <ul class="nav nav-tabs" id="myTab">
                                    ...
                                    @endif
                                    <li @if(!$payment->img) class="active" @endif>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="field-img-now" class="tab-pane fade active in">
                                        <ul class="ace-thumbnails clearfix">
                                            <li>
                                                <a href="/{{$payment->getImgPath().$payment->img}}"  data-rel="colorbox" class="cboxElement">
                                                    <img  src="/{{$payment->getImgPreviewPath().$payment->img}}">
                                                </a>
                                                <div class="tools">
                                                    <a href="{{route('admin.image.crop', ['img' => '/'.$payment->getImgPath().$payment->img, 'preview' => '/'.$payment->getImgPreviewPath().$payment->img, 'width' => $payment->getPreviewSize('width', $payment->type), 'height' => $payment->getPreviewSize('height', $payment->type)])}}" title="Изменить">
                                    ...
                                    @endif
                                    <div id="field-img-new" class="tab-pane fade @if(!$payment->img) active in @endif">
