        ...
        <div class="row cart">
           ...
           <div class="col-sm-4">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                               <table class="table table-striped table-bordered table-hover goods">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="good">
                                            ...
                                            <td>{{$good->pivot->cnt}}</td>
                                            <td>{{$good->pivot->price}}</td>
                                            <td class="hidden-480 text-success">{{$good->pivot->cnt * $good->pivot->price}}</td>
                                        </tr>
                                        @endforeach
                                        <tr>
                                            ...
                                            <td class="text-success amount">{{$order->goods->sum('pivot.cnt') * $order->goods->sum('pivot.price')}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="text-align: right">
                                                Доставка:
