                        ...
                        <div class="col-sm-9">
                            <div class="tabbable">
                                <ul class="nav nav-tabs" id="myTab">
                                    ...
                                    @endif
                                    <li @if(!$delivery->img) class="active" @endif>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="field-img-now" class="tab-pane fade active in">
                                        <ul class="ace-thumbnails clearfix">
                                            <li>
                                                <a href="/{{$delivery->getImgPath().$delivery->img}}"  data-rel="colorbox" class="cboxElement">
                                                    <img  src="/{{$delivery->getImgPreviewPath().$delivery->img}}">
                                                </a>
                                                <div class="tools">
                                                    <a href="{{route('admin.image.crop', ['img' => '/'.$delivery->getImgPath().$delivery->img, 'preview' => '/'.$delivery->getImgPreviewPath().$delivery->img, 'width' => $delivery->getPreviewSize('width', $delivery->type), 'height' => $delivery->getPreviewSize('height', $delivery->type)])}}" title="Изменить">
                                    ...
                                    @endif
                                    <div id="field-img-new" class="tab-pane fade @if(!$delivery->img) active in @endif">
