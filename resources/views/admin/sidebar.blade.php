<div id="sidebar" class="sidebar responsive">
    ...
    <ul class="nav nav-list">
        ...
        @endcan
        @can('index', new App\Models\Good())
        <li @if( str_is('admin.goods*', Route::currentRouteName()) ||
            ...
            <b class="arrow"></b>
            <ul class="submenu">
                <li  @if( str_is('admin.goods*', Route::currentRouteName())) class="active" @endif>
        ...
        @endcan
        @can('index', new App\Models\GoodComment())
        ...
        @endcan
        @can('index', new App\Models\Sertificate())
        <li  @if( str_is('admin.sertificates*', Route::currentRouteName())) class="active" @endif>
            <a href="{{route('admin.sertificates.index')}}">
