                                                ...
                                                <label>Категория:
                                                    <select name="f[id_category]" id="form-field-20">
                                                        ...
                                                        @foreach($categories_filter as $category)
                                                            ...
                                                            @include('admin.categories.dropdown', ['cats' => $category->categories()->orderBy('sort')->get(), 'index' => 1])
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                </label>
                                ...
                                @forelse($categories as $item)
                                    <tr @if($item->trashed())style="background-color: #F6CECE"@endif>
                                        ...
                                        <td class="col-sm-1 center">
                                            @if($item->icon)
                                                <img src="/{{$item->getIconPath().$item->icon}}" />
                                            @endif
                                        </td>
                                        <td class="col-sm-1 center">
                                            @if($item->img)
                                                <a data-rel="colorbox" href="/{{$item->getImgPath().$item->img}}">
                                                    <img src="/{{$item->getImgPreviewPath().$item->img}}" height="90px" />
                                                </a>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>@if($item->goods->count())
                                                ...
                                                <a class="btn btn-minier btn-info" href="{{route('admin.goods.index')}}?f[id_category]={{$item->id}}" title="Товары в категории">
                                                    <i class="ace-icon fa fa-pencil"></i>
                                                </a>
                                                <a class="btn btn-minier btn-pink" href="{{route('admin.goods.category.sort', $item->id)}}" title="Сортировка в категории">
