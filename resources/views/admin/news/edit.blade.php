                                    ...
                                    @if($news->img)
                                        <div id="field-img-now" class="tab-pane fade active in">
                                            <ul class="ace-thumbnails clearfix">
                                                <li>
                                                    <a href="/{{$news->imagePath}}"  data-rel="colorbox" class="cboxElement">
                                                        <img  src="/{{$news->imagePreviewPath}}">
                                                    </a>
                                                    <div class="tools">
                                                        <a href="{{route('admin.image.crop', ['img' => '/'.$news->imagePath, 'preview' => '/'.$news->imagePreviewPath, 'width' => $news->imagePreviewWidth, 'height' => $news->imagePreviewHeight ])}}" title="Изменить">
