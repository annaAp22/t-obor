                ...
                <div class="tabbable">
                        ...
                        <div class="table-header">
                            ...
                            <div class="ibox-tools">
                                <a href="{{route('admin.goods.create')}}" class="btn btn-success btn-xs">
                            ...
                            <div class="row-blk">
                                <form method="GET" action="{{route('admin.goods.index')}}">
                                    ...
                                    <div class="row-blk">
                                        ...
                                        <div class="col-xs-3">
                                            <div class="dataTables_filter">
                                                <a class="btn  btn-xs" href="{{route('admin.goods.index')}}?refresh=1">
                                                    Сбросить
                            ...
                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                ...
                                @forelse($goods as $item)
                                    <tr @if($item->trashed())style="background-color: #F6CECE"@endif>
                                        <td>
                                            <a href="{{route('admin.goods.edit', $item->id)}}">{{$item->name}}</a>
                                        </td>
                                        <td>{{$item->price}} руб.</td>
                                        <td class="col-sm-1 center">
                                            @if($item->img)
                                                <a data-rel="colorbox" href="/{{$item->getImgSmallPath().$item->img}}">
                                                    <img src="/{{$item->getImgPreviewPath().$item->img}}" />
                                                </a>
                                            @endif
                                        </td>
                                        ...
                                        <td class="col-sm-1 center">
                                            <div class="hidden-sm hidden-xs btn-group">
                                                @if($item->trashed())
                                                <form method="POST" action='{{route('admin.goods.restore', $item->id)}}' style="display:inline;">
                                                ...
                                                @else
                                                <a class="btn btn-xs btn-info" href="{{route('admin.goods.edit', $item->id)}}">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>
                                                <form method="POST" action='{{route('admin.goods.destroy', $item->id)}}' style="display:inline;">
