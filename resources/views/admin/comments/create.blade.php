            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="{{route('admin.comments.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="good_id" class="chosen-select chosen-autocomplite form-control" id="form-field-0" data-url="{{route('admin.goods.search')}}" data-placeholder="Начните ввод...">
                                <option value="">  </option>
                                @if($good)
