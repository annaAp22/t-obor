                        ...
                        <div class="row">
                                ...
                                <form method="GET" action="{{route('admin.comments.index')}}">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3">
                                            <div class="col-xs-12">
                                                <label>Товар:</label>
                                                <select name="f[good_id]" class="chosen-select chosen-autocomplite form-control col-xs-12" id="form-filter-search" data-url="{{route('admin.goods.search')}}" data-placeholder="Начните ввод...">
                                                    <option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                                                    @if(!empty($filters['good']))
                                                        <option value="{{$filters['good']->id}}" selected>{{$filters['good']->name}}</option>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                ...
                                @forelse($comments as $item)
                                    <tr>
                                        <td>@if($item->good) {{$item->good->name}} @endif</td>
