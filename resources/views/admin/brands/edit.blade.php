                                    ...
                                    @if($brand->img)
                                        <div id="field-img-now" class="tab-pane fade active in">
                                            <ul class="ace-thumbnails clearfix">
                                                <li>
                                                    <a href="/{{$brand->getImgPath().$brand->img}}"  data-rel="colorbox" class="cboxElement">
                                                        <img  src="/{{$brand->getImgPreviewPath().$brand->img}}">
                                                    </a>
                                                    <div class="tools">
                                                        <a href="{{route('admin.image.crop', ['img' => '/'.$brand->getImgPath().$brand->img, 'preview' => '/'.$brand->getImgPreviewPath().$brand->img, 'width' => $brand->getPreviewSize('width'), 'height' => $brand->getPreviewSize('height')])}}" title="Изменить">
