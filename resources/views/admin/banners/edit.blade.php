...
@section('main')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{route('admin.banners.index')}}">Банеры</a>
            </li>
            <li class="active">Редактирование банера</li>
        </ul><!-- /.breadcrumb -->
                                    ...
                                    @if($banner->img)
                                        <div id="field-img-now" class="tab-pane fade active in">
                                            <ul class="ace-thumbnails clearfix">
                                                <li>
                                                    <a href="/{{$banner->getImgPath().$banner->img}}"  data-rel="colorbox" class="cboxElement">
                                                        <img  src="/{{$banner->getImgPreviewPath().$banner->img}}">
                                                    </a>
                                                    <div class="tools">
                                                        <a href="{{route('admin.image.crop', ['img' => '/'.$banner->getImgPath().$banner->img, 'preview' => '/'.$banner->getImgPreviewPath().$banner->img, 'width' => $banner->getPreviewSize('width', $banner->type), 'height' => $banner->getPreviewSize('height', $banner->type)])}}" title="Изменить">
